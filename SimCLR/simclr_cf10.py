...
def train(args: DictConfig) -> None:
    ...
    state_dict = torch.load("/mnt/disk4/baodq/SimCLR-CIFAR10/logs/SimCLR/cifar10/simclr_resnet18_epoch200_batch32.pt", map_location='cpu')
